...
const client = new Client({
    ...
    auth: {
        client_id: 'd4ea05e4-e9c9-4bc6-a8b2-fef041fe5809', // ID интеграции
        client_secret: 'JYzfocCNPrkGzw8ulVbFf9071kjBKt23S8Y9jVHTeUEMMbDpfG33ORL4LHTWqP2X', // Секретный ключ
